...
export default function FinalReport({ report, onRestart }: FinalReportProps) {
  ...
  const handleScheduleCall = () => {
    window.open('mailto:advisorymbs@gmail.com?subject=Strategic Consultation Request&body=I completed the MBSA business diagnostic and would like to schedule a consultation.', '_blank');
  };
